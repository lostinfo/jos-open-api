 ...
 * url: http://open.jd.com/home/home#/doc/api?apiCateId=241&apiId=2083&apiName=jingdong.asc.audit.homepick
 * Class AscAuditHomepick
 * @package Jd\request
 */
class AscAuditHomepick
{
    ...
    /**
     * @param String $pickupStandard
     * 取件备注
     * Required: false
     * Example Value: 
     */
    private $pickupStandard;
     ...
     * Example Value: 
     */
    public function setPickupStandard($pickupStandard)
    {
        $this->pickupStandard             = $pickupStandard;
        $this->apiParas["pickupStandard"]  = $pickupStandard;
    }

    public function getPickupStandard()
    {
