 ...
 * url: http://open.jd.com/home/home#/doc/api?apiCateId=241&apiId=2445&apiName=jingdong.asc.query.count
 * Class AscQueryCount
 * @package Jd\request
 */
class AscQueryCount
{
    ...
    /**
     * @param string $approveDateBegin
     * 审核时间开始
     * Required: false
     * Example Value: 
     */
    private $approveDateBegin;
     ...
     * Example Value: 
     */
    public function setApproveDateBegin($approveDateBegin)
    {
        $this->approveDateBegin             = $approveDateBegin;
        $this->apiParas["approveTimeBegin"]  = $approveDateBegin;
    }

    public function getApproveDateBegin()
    {
        return $this->approveDateBegin;
    }

    /**
     * @param string $approveDateEnd
     * 审核时间结束
     * Required: false
     * Example Value: 
     */
    private $approveDateEnd;
     ...
     * Example Value: 
     */
    public function setApproveDateEnd($approveDateEnd)
    {
        $this->approveDateEnd             = $approveDateEnd;
        $this->apiParas["approveTimeEnd"]  = $approveDateEnd;
    }

    public function getApproveDateEnd()
    {
