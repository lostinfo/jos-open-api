 ...
 * 退供应商查询
 * ECLP仓海API-ECLP商家使用
 * url: http://open.jd.com/home/home#/doc/api?apiCateId=138&apiId=953&apiName=jingdong.eclp.rts.isvRtsQuery
 * Class EclpRtsIsvRtsQuery
 * @package Jd\request
 */
class EclpRtsIsvRtsQuery
{
    ...
    /**
     * @param string $rtsNum
     * 开放平台退供应商单号（EBS开头）;格式：EBS4XXXXXXXXX01,EBSXXXXXXX02;最多50个单号查询,中间以英文逗号分隔。
     * Required: true
