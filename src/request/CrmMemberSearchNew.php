 ...
 * 查询会员信息
 * 客户关系管理API -客户关系管理API 
 * url: http://open.jd.com/home/home#/doc/api?apiCateId=59&apiId=2857&apiName=jingdong.crm.member.searchNew
 * Class CrmMemberSearchNew
 * @package Jd\request
 */
class CrmMemberSearchNew
{
     ...
     * 会员名称,用户在京东的唯一标识。查询匹配以输入值开头的所有会员
     * Required: false
